 ...
 * Slug: restaurant-chef/single-product
 * Categories: restaurant-chef, single-product
 */
?>
...
<h2 class="wp-block-heading has-text-align-left has-large-font-size" style="margin-top:1rem;margin-bottom:1rem"><?php esc_html_e('Related Products','restaurant-chef'); ?></h2>
<!-- /wp:heading -->
