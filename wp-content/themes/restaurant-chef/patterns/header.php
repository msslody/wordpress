...
<div class="wp-block-group top-bar has-heading-background-color has-background" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:columns {"verticalAlignment":"center","className":"inner-top-bar wow fadeInDown"} -->
<div class="wp-block-columns are-vertically-aligned-center inner-top-bar wow fadeInDown"><!-- wp:column {"verticalAlignment":"center","width":"50%"} -->
...
<p class="has-background-color has-text-color has-link-color has-extra-small-font-size"><?php esc_html_e('Limited-Time Weekend Exclusive: Grab a Whopping 70% Discount','restaurant-chef'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p class="has-background-color has-text-color has-link-color has-small-font-size"><?php esc_html_e('Call: +1800 235 365','restaurant-chef'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"textColor":"background","fontSize":"small"} -->
<p class="has-background-color has-text-color has-link-color has-small-font-size"><?php esc_html_e('Email:support@example.com','restaurant-chef'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<div class="wp-block-column is-vertically-aligned-center nav-block" style="flex-basis:60%"><!-- wp:navigation {"textColor":"white","overlayBackgroundColor":"background","overlayTextColor":"heading","metadata":{"ignoredHookedBlocks":["woocommerce/customer-account","woocommerce/mini-cart"]},"style":{"typography":{"textTransform":"capitalize"}},"layout":{"type":"flex","justifyContent":"center"}} -->
...
<!-- wp:navigation-link {"label":"Buy Now","type":"link","opensInNewTab":true,"url":"https://www.ovationthemes.com/products/chef-wordpress-theme","kind":"custom","className":"buynow"} /-->
